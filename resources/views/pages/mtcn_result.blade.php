			...
			<div class="container-fluid">
				...
				<div class="row">
						...
						<div class="panel panel-headline">
							...
							<div class="panel-body">
								<table class="table" border="1" style="width:100%">
									...
									<tr>
										<td>Amount</td>
										<td><h4>{{ $resp['transaction']['receiving_currency'] .' '.$resp['transaction']['total_to_pay'] }}<h4></td>
									</tr>
									<tr>
										<td>Service Type</td>
					...
					<div class="col-md-4">
						...
						<div class="panel">
							<div class="panel-heading">
								<h3 class="panel-title">Search for MCTB</h3>
								<div class="right">
							...
							<div class="panel-body">
								<form method="post" action="{{ route('mtcn_number_search')}}">
								  ...
								  <div class="form-group">
								    ...
								    <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Eeg. 123333333">
